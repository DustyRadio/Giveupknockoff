// Clase utilizada para controlar el thumbstick. Most of the functionality is around
// Codigo simple que repasa un metodo input que registra el movimiento del objeto
...
{	
	public float smoothing = 5f;		//Controls the thumbstick inputs
	public RectTransform thumbImage;
	public float deadZone = .25f;		//The zone where the thumbstick can't pass
